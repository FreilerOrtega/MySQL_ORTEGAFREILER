correccion trabajo jardineria 


```sql

create database diagramaJardineria_Ortegafreiler;

use diagramaJardineria_Ortegafreiler;
-- drop database diagramaJardineria_OmañaJhonatan;
...
codigo_postal varchar(10),
telefono varchar(20),
liena_direccion1 varchar(50),
dinea_direccion2 varchar(50)
);
